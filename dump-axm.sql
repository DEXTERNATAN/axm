...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_EntradaEstoque_AI` AFTER insert ON `compra`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_EntradaEstoque_AU` AFTER update ON `compra`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_EntradaEstoque_AD` AFTER delete ON `compra`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_SaidaEstoque_AI` AFTER insert ON `produto_solicitacao_baixa_estoque`
FOR EACH ROW
BEGIN
      CALL SP_AtualizaBaixaEstoque (new.produto_id, new.quantidade);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_SaidaEstoque_AU` AFTER update ON `produto_solicitacao_baixa_estoque`
FOR EACH ROW
BEGIN
      CALL SP_AtualizaBaixaEstoque (new.produto_id, new.quantidade - old.quantidade);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_SaidaBaixaEstoque_AD` AFTER delete ON `produto_solicitacao_baixa_estoque`
FOR EACH ROW
BEGIN
      CALL SP_AtualizaBaixaEstoque (old.produto_id, old.quantidade * -1);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `SP_AtualizaBaixaEstoque` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_AtualizaBaixaEstoque`(`id_prod` int, `qtd_solicitada` int)
BEGIN
    declare contador int(11);

    SELECT count(*) into contador FROM produto_estoque WHERE produto_id = id_prod;

        UPDATE produto_estoque SET quantidade_baixa = quantidade_baixa + qtd_solicitada
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_AtualizaEstoque`( `id_prod` int, `qtd_comprada` int)
BEGIN
    declare contador int(11);
    ...
    IF contador > 0 THEN
        UPDATE produto_estoque SET quantidade= quantidade + qtd_comprada
        WHERE produto_id = id_prod;
    ELSE
        INSERT INTO produto_estoque (quantidade, quantidade_baixa, data_criacao,produto_id) values (qtd_comprada,0,CURRENT_DATE(), id_prod);
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2016-06-22 21:27:16
